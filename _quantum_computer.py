...
def _measure_bitstrings(
    ...
    """
    results = []
#    print('programs belongs to Program', isinstance(programs, Program))
    for program in programs:
        # copy the program so the original is not mutated
#        prog = program.copy()
        prog = copy.copy(Program(program)) 
#        print('program belongs to Program',isinstance(program, Program))
